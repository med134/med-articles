    ...
    <div className="flex flex-col justify-center shadow-md p-4 bg-light">
      ...
      <div className="flex justify-center items-center">
        ...
        <form action={handelLoginGithub}>
          <button className="text-white ml-2 w-full  bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex justify-center items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30">
            <svg
